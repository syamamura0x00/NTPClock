...
def main():
    ...
    while True:
        ...
        screen.blit(main_clock_render, (int(scrreen_height  - (main_clock_size_w / 2) - (main_sec_size_w / 2)), scrreen_height / 2 - 100))
        screen.blit(main_sec_render, (int(scrreen_height  - (main_sec_size_w / 2) + (main_clock_size_w / 2)), scrreen_height / 2 - 100))
